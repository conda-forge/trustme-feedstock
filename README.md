...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/trustme-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11111&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/trustme-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `trustme` can be installed with:

```
conda install trustme
```

It is possible to list all of the versions of `trustme` available on your platform with:
